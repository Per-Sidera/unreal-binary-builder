...
public sealed partial class AppearanceTabViewModel : ObservableObject
{
	...
	private static readonly (string Role, string Label, string Group)[] RoleLabels =
	{
		...
		("DarkPrimary",     "Primary (Dark)",  "Accent"),
		("DarkPrimary2",    "Primary (Darker)","Accent"),
		("LightPrimary",    "Primary (Light)", "Accent"),
		("Accent",          "Accent",          "Accent"),
		("Background",      "Window Background","Surfaces"),
		("Region",          "Panel",           "Surfaces"),
		("SecondaryRegion", "Card",            "Surfaces"),
		("ThirdlyRegion",   "Highlight",       "Surfaces"),
		("Border",          "Border",          "Borders"),
		("SecondaryBorder", "Border (Subtle)", "Borders"),
		("PrimaryText",     "Text",            "Text"),
		("SecondaryText",   "Text (Muted)",    "Text"),
		("ThirdlyText",     "Text (Hint)",     "Text"),
		("ReverseText",     "Text (Reverse)",  "Text"),
		("Default",         "Button",          "Buttons"),
		("DarkDefault",     "Button (Hover)",  "Buttons"),
	};
